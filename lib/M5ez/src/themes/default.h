//  This is the default theme. The values you see are all commented out because they are the
//  defaults so you do not need to specify them. Take a look at the dark.h theme file to see how
//  another theme works.
//
//  (You only need to #include this file if you offer more than one theme and want the theme chooser
//  in the settings to also offer the default theme. The original active theme at startup is the
//  last one you included until the user has saved one in the settings.)

{
  ...
  // theme.input_top = 50;									//
  // pixels below ez.canvas.top() theme.input_hmargin = 10;
  // // The distance between text box and edge of screen theme.input_vmargin = 10;
  // // Vertical margin _inside_ the text box theme.GFXfont* input_font = &FreeMonoBold12pt7b;
  // theme.GFXfont* input_keylock_font = &FreeSansBold9pt7b; theme.input_bgcolor = TFT_BLACK;

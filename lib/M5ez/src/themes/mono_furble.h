...
#define TFT_FURBLE (0xFB60)  // color565(255,111,0)
{
  ...
  // theme.longpress_time = 250;
  // //milliseconds theme.button_height = 19; theme.GFXfont* button_font = &FreeSans9pt7b;
  ...
  // theme.input_cursor_blink = 500;							//
  // milliseconds theme.input_faces_btns = 18; theme.GFXfont* tb_font = &FreeSans9pt7b;
